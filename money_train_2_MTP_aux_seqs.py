...
from training.money_experiment_2_MTP_aux_seqs import MoneyExperiment
...
# )
from training.data_loaders.stocks_time_series_2_MTP_auxilary_seqs import (
    FinancialNumericalDataModule,
    download_numerical_financial_data,
)
...
def proceed(args: argparse.Namespace):
    ...
    if args.dataset == "Money":  # yahoo finance stock data
        ...
        args.normalization_means, args.normalization_stds = download_numerical_financial_data(
            ...
            auxilary_tickers=args.auxilary_tickers,
            seq_len=seq_len,
    ...
    args.auxilary_input_features = len(data_module._metadata["auxilary_columns"])
    # --- Model Definition ---
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="./experiment_configs/aux_seq_MTP.json",
