...
from transformer_arch.money.money_former_MLA_DINT_cog_attn_2_MTP_stem import Money_former_MLA_DINT_cog_attn_MTP
from training.data_loaders.test_feats_stocks_time_series_feature_stem import (
    FinancialNumericalDataModule,
    download_numerical_financial_data,
)
from training.money_experiment_2_MTP_stem import MoneyExperiment
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="./experiment_configs/MTP_classification_exp_stem.json",
