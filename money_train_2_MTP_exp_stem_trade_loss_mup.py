...
from transformer_arch.money.money_former_MLA_DINT_cog_attn_2_MTP_stem_trade_loss_muP import Money_former_MLA_DINT_cog_attn_MTP
from training.data_loaders.test_feats_stocks_time_series_stem_trade_loss import (
    FinancialNumericalDataModule,
    download_numerical_financial_data,
)
from training.money_experiment_2_MTP_stem_trade_loss import MoneyExperiment
...
def proceed(args: argparse.Namespace):
    ...
    with open("experiment_configs/MTP_stem_trade_loss_exp_base.json", "r") as f:
